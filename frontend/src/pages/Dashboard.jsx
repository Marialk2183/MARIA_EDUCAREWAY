...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Sidebar */}
      <div className="w-64 bg-gradient-to-b from-teal-400 via-green-300 to-blue-400 text-white p-8 fixed h-full">
        <h1 className="text-3xl font-bold mb-12 bg-gradient-to-r from-white to-white bg-clip-text text-transparent">
          Student
        </h1>
        ...
        <nav className="space-y-4">
          <Link
            to="/dashboard"
            className="flex items-center space-x-3 bg-white bg-opacity-10 px-4 py-3 rounded-md hover:bg-opacity-30 transition-colors"
          >
            <MdDashboard />
            <span>Dashboard</span>
          </Link>
          ...
          <Link
            to="/"
            className="flex items-center space-x-3 px-4 py-3 rounded-md hover:bg-white hover:bg-opacity-30 transition-colors"
          >
            <FaHome />
            <span>Home</span>
          </Link>
      ...
      {/* Main Content */}
      <div className="ml-64 flex-1 flex flex-col bg-gradient-to-br from-teal-100 via-green-200 to-blue-300">
        <Navbar />
        ...
        <div className="flex-1 pt-20 px-8">
          ...
          <div className="flex items-center justify-center mb-8 py-8">
            ...
            <div className="relative w-full max-w-6xl h-96 rounded-lg overflow-hidden shadow-2xl">
              <img
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                Seminar halls are dedicated spaces for hosting presentations, workshops, and conferences, facilitating knowledge sharing and collaboration.
              </p>
            </div>
          </div>
